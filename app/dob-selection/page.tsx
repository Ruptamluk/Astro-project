...
export default function DOBSelectionPage() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#fafaf9] p-3 sm:p-4 text-slate-800">
      ...
      <div className="relative z-20 w-full max-w-lg mt-6 sm:mt-12 py-4 sm:py-8">
        <div className="text-center mb-8 sm:mb-10 space-y-4">
          <div className="flex justify-center items-center gap-3 sm:gap-4 mb-2">
            <Moon className="w-6 h-6 sm:w-8 sm:h-8 text-primary/80 animate-[pulse_3s_ease-in-out_infinite]" strokeWidth={1.5} />
            <div className="relative">
              <Star className="w-12 h-12 sm:w-14 sm:h-14 text-amber-500 animate-[spin_10s_linear_infinite]" fill="currentColor" />
              <div className="absolute inset-0 bg-amber-400/20 blur-xl rounded-full" />
            </div>
            <Sun className="w-6 h-6 sm:w-8 sm:h-8 text-secondary/80 animate-[pulse_4s_ease-in-out_infinite]" strokeWidth={1.5} />
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-primary via-slate-800 to-secondary drop-shadow-sm">
            Cosmic Alignment
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-slate-600 font-medium max-w-[90%] sm:max-w-[80%] mx-auto drop-shadow-sm">
          ...
          <div className="relative bg-white/70 backdrop-blur-3xl rounded-[1.9rem] p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8 h-full border border-black/5 disabled-text-selection">
            ...
            <div className="space-y-6">
              ...
              <div className="relative group/calendar">
                ...
                <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-3 sm:p-6 border border-amber-500/30 shadow-2xl flex justify-center pb-5 sm:pb-8 pt-3 sm:pt-4 overflow-hidden">
                  ...
                  <div className="relative z-10 w-full flex justify-center">
                    <Calendar
                      ...
                      className="bg-transparent shadow-none [&_div]:bg-transparent [&_table]:bg-transparent [&_button]:h-9 [&_button]:w-9 sm:[&_button]:h-11 sm:[&_button]:w-11 [&_button]:text-sm sm:[&_button]:text-base [&_button]:rounded-full [&_.bg-accent]:bg-primary/20 [&_.bg-accent]:text-primary [&_.bg-accent]:shadow-sm [&_.bg-accent]:font-bold [&_.text-primary]:text-primary [&_.text-primary]:font-bold [&_caption]:text-base sm:[&_caption]:text-lg [&_select]:bg-white/90 [&_select]:text-slate-800 [&_select]:border-slate-200 [&_select]:rounded-md font-medium text-slate-900 p-0 drop-shadow-sm"
                    />
                  </div>
                </div>
              </div>
            ...
            {date && (
              <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
                <div className="relative p-4 sm:p-6 rounded-2xl bg-gradient-to-br from-primary/10 via-white to-secondary/10 border border-primary/10 backdrop-blur-xl group/date overflow-hidden shadow-lg shadow-primary/5">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 relative z-10">
                    <div className="flex-1">
                      ...
                      <p className="text-3xl sm:text-4xl font-extrabold text-slate-800 mb-2 drop-shadow-sm">
                        {format(date, 'MMMM d')}
                      </p>
                      <p className="text-sm sm:text-base text-slate-600 font-medium mb-3 flex flex-wrap items-center gap-2">
                    ...
                    <div className="self-center sm:self-auto text-right flex items-center justify-center p-3 sm:p-4 bg-white rounded-full border border-primary/10 shadow-md">
                      <Star className="w-8 h-8 sm:w-10 sm:h-10 text-amber-400 drop-shadow-sm" fill="currentColor" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4 pt-4 relative z-10">
              <Button
                ...
                className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-primary via-accent to-secondary text-white h-14 sm:h-16 font-bold text-base sm:text-lg shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-secondary/40 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed border border-white/40"
              >
                ...
                <span className="relative flex items-center justify-center gap-2 sm:gap-3">
                  {loading ? (
                    ...
                    <>
                      <Moon className="w-4 h-4 sm:w-5 sm:h-5 fill-white/80" />
                      Reveal My Destiny
                      <Sun className="w-4 h-4 sm:w-5 sm:h-5 fill-white/80" />
                    </>
                  )}
                </span>
              </Button>
